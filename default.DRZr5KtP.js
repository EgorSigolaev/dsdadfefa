import {
    ...
    aL as zn,
    aM as Jn
} from "./entry.BN1AkeSJ.js";
import {_ as en} from "./image.vue.C-PIllwJ.js";
import {a as Kn, _ as tn} from "./Price.vue.Bee9HlJk.js";
import {_ as nn} from "./Preloader.CB3S504o.js";
import {u as Qn} from "./earn.CxxNlEbO.js";
import {u as qn} from "./airdrop.Cyy-pdqV.js";

const eo = "" + globalThis.__publicAssetsURL("images/lambo.png"),
    to = "" + globalThis.__publicAssetsURL("images/loading/_bg_.jpg"), no = {class: "main"},
    oo = {key: 0, class: "loading-logout"}, ro = {class: "loading-launch"},
    io = f("div", {class: "loading-launch-image"}, [f("img", {src: to, alt: "Loading screen"})], -1),
    ao = {class: "loading-launch-progress"}, so = {class: "loading-launch-progress-text"},
    co = {class: "loading-launch-bottom"},
    lo = f("div", {class: "loading-launch-text-token"}, "Hamster Kombat Token", -1),
    uo = f("div", {class: "loading-launch-text-launch"}, "will be launched", -1),
    fo = f("div", {class: "loading-launch-text-title"}, "on TON", -1), mo = {class: "loading-launch-social"},
    po = f("p", null, "Stay tuned", -1), vo = f("span", null, "More info in official channels", -1), ho = Z({
        __name: "LoadingLaunch", setup(e) {
            const t = Ke(), n = B(), o = Ne(() => S().$config.public.appEnv !== "production");
            return (r, i) => {
                const s = ve;
                return L(), A("div", no, [f("div", {
                    class: "loading-progress", style: kn({width: `${v(n).progress_loading}%`})
                }, null, 4), v(o) ? (L(), A("div", oo, [f("button", {
                    class: "button button-primary button-xs", onClick: i[0] || (i[0] = a => v(t).logout(!1))
                }, "Logout")])) : re("", !0), f("div", ro, [io, f("div", ao, [k(s, {name: "loading-yellow"}), f("div", so, se(v(t).error ? r.$t("messages.oops") : r.$t("buttons.loading")), 1)]), f("div", co, [lo, uo, fo, f("div", mo, [po, vo, f("ul", null, [f("li", null, [k(s, {
                    class: "is-telegram", name: "ln-telegram"
                })]), f("li", null, [k(s, {
                    class: "is-youtube", name: "ln-youtube"
                })]), f("li", null, [k(s, {class: "is-x", name: "ln-x"})])])])])])])
            }
        }
    }), go = "" + globalThis.__publicAssetsURL("images/qr.png"), _o = {class: "main-center"},
    bo = {class: "content-no-telegram"}, yo = ["alt"], wo = {key: 0, class: "is-version"}, So = Z({
        __name: "NotTelegram", setup(e) {
            const t = Ke();
            return (n, o) => {
                const r = Mn;
                return L(), A("main", _o, [f("div", bo, [f("p", null, se(n.$t("messages.play_mobile")), 1), k(r, {to: ("useNuxtApp" in n ? n.useNuxtApp : v(S))().$config.public.botUrl}, {
                    default: j(() => [f("img", {
                        src: go, alt: ("useNuxtApp" in n ? n.useNuxtApp : v(S))().$config.public.botName
                    }, null, 8, yo)]), _: 1
                }, 8, ["to"]), k(r, {to: ("useNuxtApp" in n ? n.useNuxtApp : v(S))().$config.public.botUrl}, {
                    default: j(() => [Cn(se(("useNuxtApp" in n ? n.useNuxtApp : v(S))().$config.public.botName), 1)]), _: 1
                }, 8, ["to"]), v(t).telegram_version || v(t).telegram_version ? (L(), A("p", wo, se(v(t).telegram_platform) + " " + se(v(t).telegram_version), 1)) : re("", !0)])])
            }
        }
    }), Lo = {class: "app-bar"}, ko = {class: "app-bar-nav"}, Co = {class: "app-bar-item-image"}, Mo = ["innerHTML"],
    xo = {class: "app-bar-item-image"}, To = ["innerHTML"], Ao = {class: "app-bar-item-image"}, Io = ["innerHTML"],
    $o = {class: "app-bar-item-image"}, Eo = {key: 0, class: "app-bar-item-notification"}, Po = ["innerHTML"],
    Wo = {class: "app-bar-item-image"}, Fo = {key: 0, class: "app-bar-item-notification"}, Ro = ["innerHTML"], Vo = Z({
        __name: "AppBar", setup(e) {
            Qe();
            const t = le(), n = B();
            return P(0), (o, r) => {
                const i = en, s = xn, a = ve, c = Tn;
                return L(), A("div", Lo, [f("nav", ko, [k(s, {
                    ...
                    default: j(() => {
                        var l;
                        return [f("div", Co, [k(i, {
                            class: "is-border-6", name: (l = v(t).currentExchange) == null ? void 0 : l.id
                        }, null, 8, ["name"])]), f("p", {innerHTML: o.$t("buttons.exchange")}, null, 8, Mo)]
                    }), _: 1
                }, 8, ["to"]), k(s, {
                    class: "app-bar-item no-select",
                    to: v(oe).GAME_MINE,
                    ...
                    default: j(() => [f("div", xo, [k(a, {
                        class: "icon-mine", name: "app-bar-mine"
                    })]), f("p", {
                    ...
                    default: j(() => [f("div", Ao, [k(a, {
                        class: "icon-friends", name: "app-bar-friends"
                    })]), f("p", {innerHTML: o.$t("buttons.friends")}, null, 8, Io)]), _: 1
                }, 8, ["to"]), k(s, {
                    class: "app-bar-item no-select",
                    to: v(oe).GAME_EARN,
                    ...
                    default: j(() => [f("div", $o, [k(a, {
                        class: "icon-earn", name: "app-bar-earn"
                    }), v(n).taskNotification ? (L(), A("div", Eo)) : re("", !0)]), f("p", {innerHTML: o.$t("buttons.earn")}, null, 8, Po)]),
                    _: 1
                }, 8, ["to"]), k(s, {
                    class: "app-bar-item no-select",
                    ...
                    default: j(() => [f("div", Wo, [k(c), v(n).taskAirdropNotification ? (L(), A("div", Fo)) : re("", !0)]), f("p", {innerHTML: o.$t("buttons.airdrop")}, null, 8, Ro)]),
                    _: 1
                }, 8, ["to"])])])
            }
        }
    }), Ho = {class: "content-coins"}, No = ["id", "initial", "enter"], Go = Z({
        __name: "CoinsAnimation", setup(e) {
            const t = P([]), {$listen: n, $event: o} = S(), r = be(),
                i = (a, c) => (a = Math.ceil(a), c = Math.floor(c), Math.floor(Math.random() * (c - a + 1)) + a), s = a => {
                    const c = Math.min(a.count, 75);
                    if (r.settings.coins_animation) for (let l = 0; l < c; l++) setTimeout(() => {
                        const d = i(a.x_start_from, a.x_start_to), u = a.random_end_x ? i(a.x_end_from, a.x_end_to) : d,
            ...
            return ye(() => {
                ...
                }, [k(l, {class: "is-20"})], 8, No)), [[d]])), 128))])
            }
        }
    }), Do = {class: "bottom-sheet-inner"}, Zo = {class: "bottom-sheet-scroll"}, Oo = Z({
        __name: "Main", props: {isOpen: {type: Boolean, default: !1}}, setup(e) {
            const {$event: t} = S(), n = P(null), o = r => {
                t("bs:close")
            };
            return In(n, {
                disableTextSelect: !0, onSwipe(r) {
                    t("bs:close")
                }, onSwipeEnd(r, i) {
                    i === "down" && t("bs:close")
                }
                ...
                const s = ve;
                return L(), z(Pn, {name: "bs-open"}, {
                    default: j(() => [Jt(f("div", {class: Kt(["bottom-sheet", {open: e.isOpen}])}, [f("div", {
                        class: "bottom-sheet-bg", onClick: o, ref_key: "bottomSheetSwipe", ref: n
                    }, null, 512), f("div", Do, [f("div", {
                        class: "bottom-sheet-close", onClick: o
                    }, [k(s, {name: "close"})]), f("div", Zo, [En(r.$slots, "default")])])], 2), [[$n, e.isOpen]])]), _: 3
                })
            }
        }
    }), Bo = Z({
        __name: "Root", setup(e) {
            const {$event: t, $listen: n} = S(), o = B(), r = P(null), i = P(null), s = P(!0), a = P(!1);
            let c;
            const l = ({component: p, props: g = null, closeOnClick: h, onCloseDialog: b}) => {
            ...
            return ye(() => {
                ...
                const h = Oo;
                return L(), z(h, {isOpen: v(a), onOnClose: u}, {
                    default: j(() => [v(r) ? (L(), z(Wn(v(r)), Fn({
                        key: 0, onOnClose: d
                    }, v(i)), null, 16)) : re("", !0)]), _: 1
                }, 8, ["isOpen"])
            }
        }
    }), on = "" + globalThis.__publicAssetsURL("images/daily-combo-success.png"), Yo = {class: "daily-combo-success-inner"},
    jo = f("div", {class: "daily-combo-success-divider"}, null, -1), Xo = {class: "daily-combo-success-header"},
    Uo = ["innerHTML"], zo = {class: "daily-combo-progress-center"},
    Jo = f("div", {class: "daily-combo-success-divider"}, null, -1), Ko = {class: "daily-combo-success-content"},
    Qo = f("div", {class: "bs-content-image is-daily-combo-info"}, [f("div", {class: "bs-content-image-round-bg is-violet"}), f("img", {src: on})], -1),
    qo = ["innerHTML"], er = f("div", {class: "daily-combo-success-divider"}, null, -1),
    tr = f("div", {class: "daily-combo-success-divider"}, null, -1), nr = Z({
        __name: "DailyComboSuccess", setup(e) {
            const t = qe(), n = () => {
            ...
            return ye(() => {
                ...
                const a = r.value, c = a.getContext("2d"), l = 50, d = 300, u = Math.PI * 2 / l;
                a.width = 400, a.height = 400;

                function m() {
                    c.clearRect(0, 0, a.width, a.height);
                    const p = a.width / 2, g = a.height / 2;
                    for (let h = 0; h < l; h++) {
                        const b = h * u + i.value, y = p + Math.cos(b) * 30, x = g + Math.sin(b) * 30,
                            C = p + Math.cos(b + Math.PI / 180 * 20) * d, I = g + Math.sin(b + Math.PI / 180 * 20) * d,
                ...
                var l;
                return L(), A("div", {
                    class: "daily-combo-success", onClick: n
                }, [f("div", Yo, [jo, f("div", Xo, [f("p", {innerHTML: a.$t("daily_combo.title")}, null, 8, Uo), f("div", zo, [f("ul", null, [(L(!0), A(pe, null, zt((l = v(t).dailyCombo) == null ? void 0 : l.upgradeIds, (d, u) => {
                    var m, p;
                    return L(), A("li", {
                        key: `ddc${u}-${d || new Date}`,
                        class: Kt({"is-completed": (p = (m = v(t).dailyCombo) == null ? void 0 : m.upgradeIds) == null ? void 0 : p[u]})
                    }, null, 2)
                }), 128))])])]), Jo, f("div", Ko, [Qo, f("canvas", {
                    ref_key: "canvasSun", ref: r
                }, null, 512)]), f("div", {class: "bs-content-subtitle", innerHTML: v(o)}, null, 8, qo), er, tr])])
            }
        }
    }), or = "" + globalThis.__publicAssetsURL("images/daily-cipher-success.webp"),
    rr = "" + globalThis.__publicAssetsURL("images/daily-cipher-success.png"), ir = or,
    ar = {class: "daily-combo-success-inner"}, sr = f("div", {class: "daily-combo-success-divider"}, null, -1),
    cr = {class: "daily-combo-success-header"}, lr = ["innerHTML"],
    ur = f("div", {class: "daily-combo-success-divider"}, null, -1), dr = {class: "daily-combo-success-content"},
    fr = {class: "bs-content-image is-daily-cipher"},
    mr = f("div", {class: "bs-content-image-round-bg is-yellow"}, null, -1),
    pr = {class: "is-daily-cipher img-responsive"}, vr = f("source", {srcset: ir, type: "image/webp"}, null, -1),
    hr = ["alt"], gr = ["innerHTML"], _r = f("div", {class: "daily-combo-success-divider"}, null, -1),
    br = {class: "daily-combo-success-button"}, yr = ["disabled"], wr = ["innerHTML"],
    Sr = f("div", {class: "daily-combo-success-divider"}, null, -1), Lr = Z({
        __name: "Success", setup(e) {
            const t = qt(), n = le(), o = P(!1), {$event: r} = S(), i = be();
            let s;
            const a = () => {
            ...
            ye(() => {
                ...
                const m = c.value, p = m.getContext("2d"), g = 50, h = 300, b = Math.PI * 2 / g;
                m.width = 400, m.height = 400;

                function y() {
                    p.clearRect(0, 0, m.width, m.height);
                    const x = m.width / 2, C = m.height / 2;
                    for (let I = 0; I < g; I++) {
                        const _ = I * b + l.value, V = x + Math.cos(_) * 30, H = C + Math.sin(_) * 30,
                            w = x + Math.cos(_ + Math.PI / 180 * 20) * h, ee = C + Math.sin(_ + Math.PI / 180 * 20) * h,
            ...
            const d = () => {
                ...
                t.getDailyCipherNotClaimed && (o.value || (o.value = !0, s = me.promise({title: S().$i18n.t("messages.process_request")}), await t.postClaimDailyCipher().then(m => {
                    X().trackEvent(ie.DAILY_CIPHER_CLAIMED), s == null || s.resolve({
                        title: S().$i18n.t("messages.claim_success"), duration: 3e3
            ...
            return (m, p) => {
                const g = ve, h = nn;
                return L(), A("div", {
                    class: "daily-combo-success", onClick: a
                }, [f("div", ar, [sr, f("div", cr, [f("p", {innerHTML: m.$t("morse.title")}, null, 8, lr)]), ur, f("div", dr, [f("div", fr, [mr, f("picture", pr, [vr, f("img", {
                    class: "img-responsive", src: rr, alt: v(et).GAME_NAME
                }, null, 8, hr)])]), f("canvas", {
                    ref_key: "canvasSun", ref: c
                }, null, 512)]), f("div", {
                    class: "bs-content-subtitle", innerHTML: m.$t("morse.code_found")
                }, null, 8, gr), _r, f("div", br, [f("button", {
                    class: "bottom-sheet-button button button-primary button-large",
                    onClick: Rn(u, ["stop"]),
                    disabled: v(o) || v(n).stop
                }, [v(o) ? (L(), z(h, {key: 1})) : (L(), A(pe, {key: 0}, [f("span", {innerHTML: m.$t("daily_combo.claim_button")}, null, 8, wr), k(g, {
                    class: "icon-heart", name: "heart"
                })], 64))], 8, yr)]), Sr])])
            }
        }
    });
    ...
    for (var t, n, o = "Unexpected syntax '".concat(e, "'"), r = /^\s*([a-z-]*)(.*)$/i.exec(e), i = r[1] || void 0, s = {}, a = /([.:#][\w-]+|\[.+?\])/gi, c = function (m, p) {
        ...
        switch (d[0]) {
            ...
            case"[": {
                ...
                if (u) c(u[1], (n = (t = u[4]) !== null && t !== void 0 ? t : u[5]) !== null && n !== void 0 ? n : ""); else throw new Error(o);
                break
            }
            default:
                throw new Error(o)
...
function ne(e, t) {
    var n = e[0] >>> 16, o = e[0] & 65535, r = e[1] >>> 16, i = e[1] & 65535, s = t[0] >>> 16, a = t[0] & 65535,
        c = t[1] >>> 16, l = t[1] & 65535, d = 0, u = 0, m = 0, p = 0;
...
var Ar = [4283543511, 3981806797], Ir = [3301882366, 444984403];
...
var Fe = [2277735313, 289559509], Re = [1291169091, 658871167], Dt = [0, 5], $r = [0, 1390208809], Er = [0, 944331445];

function Pr(e, t) {
    var n = Tr(e);
    t = t || 0;
    var o = [0, n.length], r = o[1] % 16, i = o[1] - r, s = [0, t], a = [0, t], c = [0, 0], l = [0, 0], d;
    ...
    var n = new Promise(function (o) {
        ...
        Ht(e.bind(null, t), function () {
            ...
            if (!i[0]) return o(function () {
                return {error: i[1], duration: a}
            });
            var c = i[1];
            if (Rr(c)) return o(function () {
                return {value: c, duration: a}
            });
            o(function () {
...
function Oe() {
    var e = window, t = navigator, n = e.CSS, o = e.HTMLButtonElement;
...
function dn() {
    var e = ot(), t = un(), n = window, o = navigator, r = "connection";
...
function jr(e, t) {
    for (var n = 0, o = t.split(";"); n < o.length; n++) {
        var r = o[n], i = /^\s*([\w-]+)\s*:\s*(.+?)(\s*!([\w-]+))?\s*$/.exec(r);
        if (i) {
            var s = i[1], a = i[2], c = i[4];
            e.setProperty(s, a, c || "")
        }
    }
}
...
function Xr() {
    return new Promise(function (e) {
        var t = document, n = "visibilitychange", o = function () {
...
function ti(e, t) {
    for (var n = void 0, o = !1, r = 0; r < t.length; r += Math.floor(t.length / 10)) if (t[r] !== 0) {
        if (n === void 0) n = t[r]; else if (n !== t[r]) {
            o = !0;
            break
        }
    }
...
function oi(e, t) {
    if (e === 0) return e;
    var n = Math.floor(Math.log10(Math.abs(e))), o = n - Math.floor(t) + 1, r = Math.pow(10, -o) * (t * 10 % 10 || 1);
    return Math.round(e * r) / r
}

var ri = "mmMwWLliI0O&1", ii = "48px", de = ["monospace", "sans-serif", "serif"],
                ...
                switch (b.label) {
                    case 0:
                        return r = o.body, r.style.fontSize = ii, i = o.createElement("div"), i.style.setProperty("visibility", "hidden", "important"), s = {}, a = {}, c = function (y) {
                            var x = o.createElement("span"), C = x.style;
...
function vi(e, t) {
    ...
    for (var n = 0, o = [["#f2f", 40, 40], ["#2ff", 80, 40], ["#ff2", 60, 80]]; n < o.length; n++) {
        var r = o[n], i = r[0], s = r[1], a = r[2];
...
function bi() {
    ...
    if (n !== void 0 && t.push([n]), Array.isArray(e.languages)) ot() && Gr() || t.push(e.languages); else if (typeof e.languages == "string") {
        var o = e.languages;
        o && t.push(o.split(","))
    }
    return t
...
function Li() {
    var e = screen, t = function (o) {
        return q(nt(o), null)
    }, n = [t(e.width), t(e.height)];
    return n.sort().reverse(), n
}

var ki = 2500, Ci = 10, He, Ye;
            ...
            switch (l.label) {
                ...
                case 1:
                    return s = l.sent(), n && Yi(o, s), a = r.filter(function (d) {
                        var u = o[d], m = N(u.map(function (p) {
                            return s[p]
                        }));
                        return m > u.length * .6
                    }), a.sort(), [2, a]
...
function Ji() {
    if (matchMedia("(min-monochrome: 0)").matches) {
        for (var e = 0; e <= zi; ++e) if (matchMedia("(max-monochrome: ".concat(e, ")")).matches) return e;
...
var M = Math, R = function () {
    return 0
};

function ta() {
    var e = M.acos || R, t = M.acosh || R, n = M.asin || R, o = M.asinh || R, r = M.atanh || R, i = M.atan || R,
        s = M.sin || R, a = M.sinh || R, c = M.cos || R, l = M.cosh || R, d = M.tan || R, u = M.tanh || R,
        m = M.exp || R, p = M.expm1 || R, g = M.log1p || R, h = function (w) {
            return M.pow(M.PI, w)
        }, b = function (w) {
...
function oa() {
    return ra(function (e, t) {
        for (var n = {}, o = {}, r = 0, i = Object.keys(je); r < i.length; r++) {
            var s = i[r], a = je[s], c = a[0], l = c === void 0 ? {} : c, d = a[1], u = d === void 0 ? na : d,
...
function ra(e, t) {
    return t === void 0 && (t = 4e3), fn(function (n, o) {
        var r = o.document, i = r.body, s = i.style;
...
var pn = -1, vn = -2,
    ...
    hn = "WEBGL_debug_renderer_info", pa = "WEBGL_polygon_mode";

function va(e) {
    var t, n, o, r, i, s, a = e.cache, c = gn(a);
    if (!c) return pn;
    if (!bn(c)) return vn;
...
function ha(e) {
    var t = e.cache, n = gn(t);
    if (!n) return pn;
    if (!bn(n)) return vn;
    var o = n.getSupportedExtensions(), r = n.getContextAttributes(), i = [], s = [], a = [], c = [];
    if (r) for (var l = 0, d = Object.keys(r); l < d.length; l++) {
        var u = d[l];
    ...
    if (o) for (var y = 0, x = o; y < x.length; y++) {
        var C = x[y];
        if (!(C === pa || C === hn && _n())) {
    ...
    for (var H = 0, w = fa; H < w.length; H++) for (var ee = w[H], J = 0, he = ma; J < he.length; J++) {
        var ge = he[J], we = ga(n, ee, ge);
        c.push("".concat(ee, ".").concat(ge, "=").concat(we.join(",")))
    }
    return a.sort(), s.sort(), {
        contextAttributes: i, parameters: s, shaderPrecisions: c, extensions: o, extensionParameters: a
    }
}
...
function Sa(e) {
    var t = La(e), n = ka(t);
    return {score: t, comment: wa.replace(/\$/g, "".concat(n))}
}
...
function Ca(e) {
    for (var t = "", n = 0, o = Object.keys(e).sort(); n < o.length; n++) {
        var r = o[n], i = e[r], s = "error" in i ? "error" : JSON.stringify(i.value);
...
function Ma(e) {
    ...
    return {
        get visitorId() {
            ...
            t = o
        }, confidence: n, components: e, version: an
    }
}
    ...
    return e === void 0 && (e = {}), W(this, void 0, void 0, function () {
        ...
        return F(this, function (i) {
            switch (i.label) {
                ...
                case 1:
                    return i.sent(), r = ya({cache: {}, debug: o}), [2, Ta(r, o)]
            }
        })
    })
}

var $a = {load: Ia, hashComponents: wn, componentsToDebugString: yn};
const Ea = {class: "bs-content"}, Pa = {class: "bs-content-image"}, Wa = ["src"], Fa = ["innerHTML"],
    Ra = {class: "upgrade-buy-stats"}, Va = ["innerHTML"], Ha = {class: "upgrade-buy-stats-info"}, Na = ["innerHTML"],
    Ga = {class: "upgrade-buy-stats-info"}, Da = ["innerHTML"], Za = Z({
        __name: "LevelUp", setup(e) {
            const {$event: t} = S();
            le();
            const n = tt();
            X();
            ...
            return (r, i) => (L(), A("div", Ea, [f("div", Pa, [f("img", {
                class: "is-coin-star", src: "IMAGE_COIN_STAR" in r ? r.IMAGE_COIN_STAR : v(Vn)
            }, null, 8, Wa)]), f("div", {
                class: "bs-content-title", innerHTML: r.$t("messages.level_up_success")
            }, null, 8, Fa), f("ul", Ra, [f("li", null, [f("p", {innerHTML: r.$t("boost.boost_multitap")}, null, 8, Va), f("div", Ha, "+" + se(v(n).levelUpEarnPerTap ?? 1), 1)]), f("li", null, [f("p", {innerHTML: r.$t("boost.boost_energy_limit")}, null, 8, Na), f("div", Ga, "+" + se(v(n).levelUpMaxTaps ?? 500), 1)])]), f("button", {
                class: "bottom-sheet-button button button-primary button-large", onClick: o
            }, [f("span", {innerHTML: r.$t("buttons.close")}, null, 8, Da)])]))
        }
    }), Oa = {class: "bs-passive"}, Ba = {class: "bs-passive-inner"}, Ya = {class: "bs-passive-exchange"},
    ja = ["innerHTML"], Xa = ["disabled"], Ua = ["innerHTML"], za = Z({
        __name: "PassiveIncomeOffline", setup(e) {
            const {$event: t} = S(), n = le();
            X();
            const o = be(), r = P(!1);
            ...
            return (s, a) => {
                var u, m;
                const c = en, l = tn, d = ve;
                return L(), A("div", Oa, [f("div", Ba, [f("div", Ya, [k(c, {name: (u = v(n).currentExchange) == null ? void 0 : u.id}, null, 8, ["name"])]), k(l, {
                    price: v(n).lastPassiveEarn, size: "xx-large"
                }, null, 8, ["price"]), f("p", {innerHTML: s.$t("exchange.work_for_you")}, null, 8, ja)]), f("button", {
                    class: "bottom-sheet-button button button-primary button-large", onClick: i, disabled: v(r)
                }, [f("span", {innerHTML: s.$t("exchange.thank_you", {name: ((m = v(n).currentExchange) == null ? void 0 : m.name) ?? "unknown"})}, null, 8, Ua), k(d, {
                    class: "icon-heart", name: "heart"
                })], 8, Xa)])
            }
        }
    }), Ja = {class: "bs-content"}, Ka = f("div", {class: "bs-content-image is-w100"}, [f("img", {src: eo})], -1),
    Qa = ["innerHTML"], qa = ["innerHTML"], es = ["innerHTML"], ts = Z({
        __name: "JoinBot", setup(e) {
            const {$event: t} = S();
            le(), X(), tt(), Qe();
            ...
            return (o, r) => (L(), A("div", Ja, [Ka, f("div", {
                class: "bs-content-title has-top-gap", innerHTML: o.$t("messages.join_bot_title")
            }, null, 8, Qa), f("div", {
                class: "bs-content-target no-gap",
                innerHTML: o.$t("messages.join_bot_description", {bot_name: v(et).GAME_NAME})
            }, null, 8, qa), f("button", {
                class: "bottom-sheet-button button button-primary button-large", onClick: n
            }, [f("span", {innerHTML: o.$t("messages.join_bot_button")}, null, 8, es)])]))
        }
    }), ns = {class: "bs-content"},
    os = f("div", {class: "bs-content-image is-daily-combo-info"}, [f("div", {class: "bs-content-image-round-bg is-violet"}), f("img", {src: on})], -1),
    rs = ["innerHTML"], is = {class: "upgrade-buy-info"}, as = ["disabled"], ss = ["innerHTML"], cs = Z({
        __name: "DailyComboClaim", setup(e) {
            const {$event: t} = S(), n = P(!1), o = qe(), r = le(), i = be();
            ...
            let a;
            const c = async () => {
                o.getDailyComboNotClaimed && (n.value || (n.value = !0, a = me.promise({title: S().$i18n.t("messages.process_request")}), await o.postClaimDailyCombo().then(d => {
            ...
            return (d, u) => {
                var h;
                const m = tn, p = ve, g = nn;
                return L(), A("div", ns, [os, f("div", {
                    class: "bs-content-subtitle", innerHTML: d.$t("daily_combo.claim_title")
                }, null, 8, rs), f("div", is, [k(m, {
                    price: ((h = v(o).dailyCombo) == null ? void 0 : h.bonusCoins) ?? 1e4, size: "large", round: !1
                }, null, 8, ["price"])]), f("button", {
                    class: "bottom-sheet-button button button-primary button-large pulse",
                    onClick: c,
                    disabled: v(n) || v(r).stop
                }, [v(n) ? (L(), z(g, {key: 1})) : (L(), A(pe, {key: 0}, [f("span", {innerHTML: d.$t("daily_combo.claim_button")}, null, 8, ss), k(p, {
                    class: "icon-heart", name: "heart"
                })], 64))], 8, as)])
            }
        }
    }), ls = {class: "page"}, us = f("div", {id: "ton-connect-widget"}, null, -1), ds = 7, bs = Z({
        __name: "default", setup(e) {
            const {locales: t, setLocale: n} = Hn(), o = Nn();
            Gn({title: `${et.GAME_NAME}`});
            const {$stopListen: r, $listen: i, $event: s} = S(), a = Qe(), c = Ke(), l = le();
            Dn();
            const d = qe(), u = tt(), m = B(), p = Qn(), g = qn(), h = be(), b = qt(), y = Zn(), x = P(!1), C = P(0);
            let I = !1, _ = !1, V, H, w = null;
            const ee = Ne(() => t.value.map($ => $.code)), J = {
                ...On,
            ...
            ye(async () => {
                var G, E, K, Se, Le, ke, Ce, Me, xe, Te, Ae, Ie, _e, ct, lt, ut, dt, ft, mt, pt, vt, ht, gt, _t, bt, yt, wt,
                    St, Lt, kt, Ct, Mt, xt, Tt, At, It, $t, Et, Pt, Wt, Ft;
                w = Bn(() => {
                ...
                if (I) if (await c.check(), c.authenticated) await he(); else {
                    const Q = await $a.load(), {visitorId: U, components: $e, version: Ee} = await Q.get();
                    await c.postLogin({
                        ...
                        fingerprint: {version: Ee, visitorId: U, components: {...$e, canvas: null, webGlExtensions: null}}
                    }).then(async Ln => {
                        te(1), H && (c.opened_by_miniapp = !0, await ge(Number(H)).catch(fs => {
                        })), await he()
                    }).catch(Ln => {
                        me.error({
            ...
            const he = async () => {
                _ || await c.postGetMe().then(async $ => {
                    ...
                    const G = "12345";
                    console.log("GGG!!!");
                    if (C.value !== 0 && Number.isFinite(G) && Number(C.value) !== Number(G)) await c.postWebappConflict({
                        userId1: Number(G), userId2: Number(C.value)
                    }).finally(() => {
                        c.logout(), setTimeout(() => {
                            var E, K;
                        ...
                        _ || (l.setFirstTimeLoad(!0), await l.postSync().catch(E => {
                            ...
                            _ = !0
                        }), te(6)), _ || (await g.postListTasks().catch(E => {
                        }), te(7)), _ || l.setFirstTimeLoad(!1)
                    }
                }).catch($ => {
                    me.error({
                        title: S().$i18n.t("messages.request_error"),
            ...
            async function ge($, G = 1, E = 5) {
                try {
                    ...
                    if (K.statusCode >= 500) G < E ? await ge($, G + 1, E) : _ = !0; else return
                }
            }
            ...
            function it() {
                s("bs:close"), setTimeout(() => {
                    X().trackEvent(ie.REFERRAL_SHOW_DIALOG_JOIN_BOT), s("bs:open", {component: We(ts)})
                }, 400)
            }
            ...
            function at() {
                s("bs:close"), setTimeout(() => {
                    ...
                    ($ = m.notificationLevelUp) == null || $.resolve({
                        title: S().$i18n.t("messages.level_up_success"), duration: 3e3
                    }), m.notificationLevelUp = null, l.setStop(!1), setTimeout(() => {
                        s("bs:open", {component: We(Za)})
                    }, 400)
                }, 400)
            }

            const st = () => {
                s("bs:open", {component: We(cs)})
            }, te = $ => {
            ...
            return ($, G) => {
                const E = ho, K = So, Se = jn, Le = Vo, ke = Go, Ce = Bo, Me = nr, xe = Lr, Te = zn, Ae = Jn, Ie = Xn;
                return L(), A("div", ls, [v(c).loading ? (L(), z(E, {key: 0})) : (L(), A(pe, {key: 1}, [v(c).is_telegram ? (L(), A(pe, {key: 1}, [k(v(Un), {
                    visible: v(x), onClick: v(m).goBackButton
                }, null, 8, ["visible", "onClick"]), k(Se), v(l).exchangeId ? (L(), z(Le, {key: 0})) : re("", !0), k(ke)], 64)) : (L(), z(K, {key: 0}))], 64)), k(Ce), v(d).dailyCombo && v(d).dailyComboSuccess ? (L(), z(Me, {key: 2})) : re("", !0), v(b).dailyCipherSuccess && v(b).getDailyCipherNotClaimed ? (L(), z(xe, {key: 3})) : re("", !0), us, k(Ie, null, {
                    default: j(_e => [k(Ae, {item: _e}, {
                        default: j(() => [k(Te, {
                            item: _e, theme: J
                        }, null, 8, ["item"])]), _: 2
                    }, 1032, ["item"])]), _: 1
